...
# ``Repeats`` moved to :mod:`sequana.repeats.shustring`. Re-exported here for
# backward compatibility (``from sequana.sequence import Repeats``).
from sequana.repeats.shustring import Repeats  # noqa: F401,E402
