...
__all__ = ["plot_venn", "get_layout", "default_colors"]
...
def get_layout(n):
    """Get the layout structure for an n-set Venn diagram.

    :param n: Number of sets (2 to 6)
    :return: Layout dict with 'shapes', 'texts', and 'names' keys
    """
    layouts = {
        2: {
            "shapes": [
        ...
        6: {
            ...
            "texts": [
                {"x": 0.212, "y": 0.562, "text": ""},
                {"x": 0.430, "y": 0.249, "text": ""},
                {"x": 0.356, "y": 0.444, "text": ""},
                {"x": 0.609, "y": 0.255, "text": ""},
                {"x": 0.323, "y": 0.546, "text": ""},
                {"x": 0.513, "y": 0.316, "text": ""},
                {"x": 0.523, "y": 0.348, "text": ""},
                {"x": 0.747, "y": 0.458, "text": ""},
                {"x": 0.325, "y": 0.492, "text": ""},
                {"x": 0.670, "y": 0.481, "text": ""},
                {"x": 0.359, "y": 0.478, "text": ""},
                {"x": 0.653, "y": 0.444, "text": ""},
                {"x": 0.344, "y": 0.526, "text": ""},
                {"x": 0.653, "y": 0.466, "text": ""},
                {"x": 0.363, "y": 0.503, "text": ""},
                {"x": 0.750, "y": 0.616, "text": ""},
                {"x": 0.682, "y": 0.654, "text": ""},
                {"x": 0.402, "y": 0.310, "text": ""},
                {"x": 0.392, "y": 0.421, "text": ""},
                {"x": 0.653, "y": 0.691, "text": ""},
                {"x": 0.651, "y": 0.644, "text": ""},
                {"x": 0.490, "y": 0.340, "text": ""},
                {"x": 0.468, "y": 0.399, "text": ""},
                {"x": 0.692, "y": 0.545, "text": ""},
                {"x": 0.666, "y": 0.592, "text": ""},
                {"x": 0.665, "y": 0.496, "text": ""},
                {"x": 0.374, "y": 0.470, "text": ""},
                {"x": 0.653, "y": 0.537, "text": ""},
                {"x": 0.652, "y": 0.579, "text": ""},
                {"x": 0.653, "y": 0.488, "text": ""},
                {"x": 0.389, "y": 0.486, "text": ""},
                {"x": 0.553, "y": 0.806, "text": ""},
                {"x": 0.313, "y": 0.604, "text": ""},
                {"x": 0.388, "y": 0.694, "text": ""},
                {"x": 0.375, "y": 0.633, "text": ""},
                {"x": 0.605, "y": 0.359, "text": ""},
                {"x": 0.334, "y": 0.555, "text": ""},
                {"x": 0.582, "y": 0.397, "text": ""},
                {"x": 0.542, "y": 0.372, "text": ""},
                {"x": 0.468, "y": 0.708, "text": ""},
                {"x": 0.355, "y": 0.572, "text": ""},
                {"x": 0.420, "y": 0.679, "text": ""},
                {"x": 0.375, "y": 0.597, "text": ""},
                {"x": 0.641, "y": 0.436, "text": ""},
                {"x": 0.348, "y": 0.538, "text": ""},
                {"x": 0.635, "y": 0.453, "text": ""},
                {"x": 0.370, "y": 0.548, "text": ""},
                {"x": 0.594, "y": 0.689, "text": ""},
                {"x": 0.579, "y": 0.670, "text": ""},
                {"x": 0.398, "y": 0.670, "text": ""},
                {"x": 0.395, "y": 0.653, "text": ""},
                {"x": 0.633, "y": 0.682, "text": ""},
                {"x": 0.616, "y": 0.656, "text": ""},
                {"x": 0.587, "y": 0.427, "text": ""},
                {"x": 0.526, "y": 0.415, "text": ""},
                {"x": 0.495, "y": 0.677, "text": ""},
                {"x": 0.505, "y": 0.648, "text": ""},
                {"x": 0.428, "y": 0.663, "text": ""},
                {"x": 0.430, "y": 0.631, "text": ""},
                {"x": 0.639, "y": 0.524, "text": ""},
                {"x": 0.591, "y": 0.604, "text": ""},
                {"x": 0.622, "y": 0.477, "text": ""},
                {"x": 0.501, "y": 0.523, "text": ""},
            ],
            "names": [
