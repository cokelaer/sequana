# This file is part of UpSetPlot (https://github.com/jnothman/UpSetPlot),
# vendored into Sequana at version 0.9.0 under the New BSD License.
# Copyright (c) 2018-2024 Joel Nothman. See the LICENSE file in this directory.
#
# Local changes are marked with a "sequana:" comment.
import typing
import warnings
...
class UpSet:
    ...
    def plot_matrix(self, ax):
        ...
        # sequana: the original code used styles[col].fillna(value, inplace=True),
        # which is a no-op with the copy-on-write semantics of pandas >= 3 and
        # leaves NaN colours behind (ValueError: Invalid RGBA argument: nan).
